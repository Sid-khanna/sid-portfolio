  ...
  return (
    ...
    >
      ...
      <section className="space-y-4 text-sm md:text-base text-neutral-800 leading-relaxed">
        ...
        <p>
          Our final design — <span className="font-medium">the Helping Hand</span> —
          was selected after an extensive concept generation process. I led the
          technical design work, creating CAD models, animations, and detailed
        ...
        <p>
          ...
          also reinforced the value of clear communication and stakeholder-driven
